...
exports.CaptacionesService = void 0;
const captaciones_repository_1 = require("./captaciones.repository");
class CaptacionesService {
    constructor() {
        this.captacionesRepository = new captaciones_repository_1.CaptacionesRepository();
    }
    /**
     ...
     */
    async obtenerCaptacionesVista(codigoOficina) {
        try {
     ...
     */
    async obtenerCaptacionesPlazo(codigoOficina) {
        try {
...
exports.CaptacionesService = CaptacionesService;
